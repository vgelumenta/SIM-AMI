<x-app-layout>
    <form action="{{ route('forms.updateFeedback', $form->id) }}" method="POST" class="flex h-full w-full flex-col">
        @csrf
        @method('PUT')
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="flex items-center gap-3">
                                                                            ...
                                                                            <!-- Modal Content -->                                                                            
                                                                            <template
                                                                                x-if="!indicator.feedback | !indicator.comment">
                                                                                <button
                                                                                    x-show="
                                                                            ['Option', 'Digit', 'Decimal', 'Cost', 'Percentage', 'Rate'].includes(indicator.entry)"
                                                                                    ...
                                                                                    <i
                                                                                        class="fa-solid fa-comment-dots fa-lg"></i>
                                                                                </button>
                                                                            </template>
                                                                            <template
                                                                                x-if="indicator.feedback && indicator.comment">
                                                                        ...
                                                                        <div x-show="isModalOpen && currentIndicatorId === indicator.id"
                                                                            ...
                                                                            <div x-show="isModalOpen && currentIndicatorId === indicator.id"
                                                                                ...
                                                                                class="max-h-[85vh] w-full max-w-4xl overflow-hidden rounded-t-lg bg-white px-5 py-4 text-left dark:bg-gray-800 sm:m-4 sm:max-w-xl sm:rounded-lg"
                                                                                role="dialog"
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <textarea x-model="indicator.comment"
                                                                                                :name="'feedbacks[' +
                                                                                                indicator.id +
                                                                                                    '][comment]'"
                                                                                                class="w-[90%] border-b-2 border-x-transparent border-b-gray-200 border-t-transparent bg-transparent px-3 py-0 font-semibold scrollbar-thin focus:border-x-transparent focus:border-b-indigo-600 focus:border-t-transparent focus:ring-0 dark:scrollbar-track-gray-500 dark:scrollbar-thumb-gray-800"
                                                                                                style="text-align: justify" placeholder="Masukkan umpan balik">
                                                                                            </textarea>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
