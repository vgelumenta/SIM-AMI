<x-app-layout>
    <form id="form" action="{{ route('forms.updateFeedback', $form) }}" method="POST"
        ...
        <div class="flex items-center justify-between py-1 text-indigo-700 dark:text-cool-gray-50 md:text-lg">
            <ol class="flex items-center gap-x-1">
                ...
                <li class="hidden xl:block">Feedback</li>
            </ol>
                                                        ...
                                                        <td
                                                            ...
                                                            <template x-for="indicator in competency.indicators"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <!-- Modal Content -->
                                                                    <template
                                                                        x-if="!indicator.validation | !indicator.link | !indicator.feedback | !indicator.comment">
                                                                        <button
                                                                            x-show="
                                                                    ...
                                                                    <div x-show="focusIndicator.id === indicator.id"
                                                                        ...
                                                                        <div x-show="focusIndicator.id === indicator.id"
                                                                            ...
                                                                            x-transition:leave-start="opacity-100"
                                                                            x-transition:leave-end="opacity-0 transform translate-y-1/2"
                                                                            class="flex w-full max-w-6xl flex-col gap-2 overflow-hidden rounded-t-lg bg-white p-4 dark:bg-gray-800 sm:rounded-lg"
