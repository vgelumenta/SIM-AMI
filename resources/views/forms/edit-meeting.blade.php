<x-app-layout>
    <form x-data="user()" id="form" action="{{ route('forms.updateMeeting', $form) }}"
        ...
        <div class="flex items-center justify-between py-1 text-indigo-700 dark:text-cool-gray-50 md:text-lg">
            <ol class="flex items-center gap-x-1">
                ...
                <li class="hidden xl:block">Meeting Evidence</li>
            </ol>
        ...
        <div
            ...
            <header class="text-center">
                <h2 class="text-lg text-gray-900 dark:text-white">
                    {{ __('Lampirkan Laporan RTM') }}
                </h2>

                <p class="text-sm text-gray-600 dark:text-gray-300">
                    {{ __('Masukkan Laporan dan Tanggal Rapat Tinjau Manajemen.') }}
                </p>
            </header>
            ...
            <div class="mx-auto max-w-4xl">
                <div class="grid gap-6 lg:grid-cols-2">
                    ...
                    <!-- Time -->
                    <div class="space-y-1 text-sm">
                        <label for="time" class="text-gray-900 dark:text-white">{{ __('Time') }}</label>
