<x-app-layout>
    <form action="{{ route('forms.updateVerification', $form->id) }}" method="POST" class="flex h-full w-full flex-col">
        @csrf
        @method('PUT')
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div x-show="isModalOpen && currentIndicatorId === indicator.id"
                                                                            ...
                                                                            <div x-show="isModalOpen && currentIndicatorId === indicator.id"
                                                                                ...
                                                                                class="max-h-[85vh] w-full max-w-7xl overflow-hidden rounded-t-lg bg-white px-5 py-4 text-left dark:bg-gray-800 sm:m-4 sm:max-w-xl sm:rounded-lg"
                                                                                role="dialog"
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <textarea x-model="indicator.description" disabled
                                                                                                ...
                                                                                                style="text-align: justify" placeholder="Komentar audit">
                                                                                            </textarea>
                                                                                        </div>
                                                                                    </div>
                                                                                    ...
                                                                                    <!-- Feedback form -->
                                                                                    <div
                                                                                        class="{{ $form->stage_id == 3 ? 'text-indigo-600' : 'text-gray-600' }} flex flex-col gap-y-5">
                                                                                        <div>
                                                                                            Feedback Form
                                                                                        </div>
                                                                                        <div
                                                                                            ...
                                                                                            <select
                                                                                                x-model="indicator.feedback" disabled
                                                                                                class="w-[90%] border-b-2 border-x-transparent border-b-gray-200 border-t-transparent bg-transparent py-0 font-semibold focus:border-x-transparent focus:border-b-indigo-600 focus:border-t-transparent focus:ring-0">
                                                                                                <option hidden
                                                                                                    value="">
                                                                                                    Respon Auditee
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <textarea x-model="indicator.comment" disabled
                                                                                                class="w-[90%] border-b-2 border-x-transparent border-b-gray-200 border-t-transparent bg-transparent px-3 py-0 font-semibold scrollbar-thin focus:border-x-transparent focus:border-b-indigo-600 focus:border-t-transparent focus:ring-0 dark:scrollbar-track-gray-500 dark:scrollbar-thumb-gray-800"
                                                                                                style="text-align: justify" placeholder="Umpan balik Auditee">
                                                                                            </textarea>
                                                                                        </div>
                                                                                    </div>
                                                                                    ...
                                                                                    <!-- Verification form -->
                                                                                    <div
                                                                                        class="{{ $form->stage_id == 4 ? 'text-indigo-600' : 'text-gray-600' }} flex flex-col gap-y-5">
                                                                                        <div>
                                                                                            Verification Form
                                                                                        </div>
                                                                                        <div
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <textarea x-model="indicator.conclusion"
                                                                                                ...
                                                                                                indicator.id +
                                                                                                    '][conclusion]'"
                                                                                                class="w-[90%] border-b-2 border-x-transparent border-b-gray-200 border-t-transparent bg-transparent px-3 py-0 font-semibold scrollbar-thin focus:border-x-transparent focus:border-b-indigo-600 focus:border-t-transparent focus:ring-0 dark:scrollbar-track-gray-500 dark:scrollbar-thumb-gray-800"
                                                                                                style="text-align: justify" placeholder="Masukkan kesimpulan akhir">
                                                                                            </textarea>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
