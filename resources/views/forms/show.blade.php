                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <textarea x-model="indicator.description" disabled
                                                                                                ...
                                                                                                style="text-align: justify" placeholder="Komentar Auditor">
                                                                                            </textarea>
                                                                                        </div>
                                                                                    </div>
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <textarea x-model="indicator.comment" disabled
                                                                                                class="w-[90%] border-b-2 border-x-transparent border-b-gray-200 border-t-transparent bg-transparent px-3 py-0 font-semibold scrollbar-thin focus:border-x-transparent focus:border-b-indigo-600 focus:border-t-transparent focus:ring-0 dark:scrollbar-track-gray-500 dark:scrollbar-thumb-gray-800"
                                                                                                style="text-align: justify" placeholder="Komentar Auditee">
                                                                                            </textarea>
                                                                                        </div>
                                                                                    </div>
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <textarea x-model="indicator.conclusion" disabled
                                                                                                class="w-[90%] border-b-2 border-x-transparent border-b-gray-200 border-t-transparent bg-transparent px-3 py-0 font-semibold scrollbar-thin focus:border-x-transparent focus:border-b-indigo-600 focus:border-t-transparent focus:ring-0 dark:scrollbar-track-gray-500 dark:scrollbar-thumb-gray-800"
                                                                                                style="text-align: justify" placeholder="Kesimpulan akhir">
                                                                                            </textarea>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
